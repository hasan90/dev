...
?>
<Response><Gather numDigits="1" action="<?php echo WEBSITE_URL;?>complete_test_call.php?data=<?php echo $_REQUEST['data']; ?>"><Pause length="1"/><?php echo $datax; ?></Gather></Response>
