...
class ApiController extends Zend_Rest_Controller
{
    ...
    public function responsereturn($inquiryId,$auth_key)
    {
		...
		$find =  PROCESS_URL;
	 	...
	 	else if(count($inquiry_data) == 1 && (($authKey_format[1] == "json" || $authKey_format[1] == "xml" ) || ($data['redirect_type'] == 3 || $data['redirect_type'] == 4)))
	 	{
	    	...
	    	$test_array = array (
				...
				if($authKey_format[1] == "json" || $data['redirect_type'] == 3)
				{				
					header('Content-type: application/json');
					echo json_encode($test_array );
				}
				if($authKey_format[1] == "xml" || $authKey_format[1] == '' || $authKey_format[1] == "default" || $data['redirect_type'] == 4)
				{	
