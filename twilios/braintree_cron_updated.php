...
'".$subscription_price['price']."','".$result->transaction->id."','".$row['status']."','Cron')");
	...
	$res1=mysql_query($updatequery);
		...
		$Body.="Your account is recharged by the system. Your new subscription plan entitles you to ".$subscription_price['name']." at a rate of $".$subscription_price['price'];
