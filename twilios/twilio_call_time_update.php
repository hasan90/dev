...
if($cnt>0){
    ...
    <img src='". WEBSITE_IMG_URL. "branding.png' /> <hr />";
        ...
        $body.="Hi, <br /><br /> You have got a new call. <br /><br /> <b>Call Summary:</b> <br /><br /> CallerID : {$phone_number} <br /><br /> Date : {$date} <br /><br /> Time: {$call_time} <br /><br /> Duration: {$time} mins {$answer}<br /><br />";
