...
<Response>
    ...
    <?php elseif($_REQUEST['Digits'] == '0'): ?>
        <Gather numDigits="1" action="complete_call.php?data=<?php echo $_REQUEST['data']; ?>"><Say>A customer at the number <?php echo $user_phone_words?> is calling.</Say><Pause length="0.5"/><?php echo $datax; ?></Gather>
    <?php elseif($_REQUEST['Digits'] == '6'):
            include_once 'save_delay_call.php';
    ?>
    <Say voice="woman">You get call after five minutes, Thank You</Say>
